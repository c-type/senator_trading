...
#%% parse website into list of trade objects
...
for trade_block in trade_start_lines:
    ...
    trades.append(Trade(stock, date, senator, action, amount, party))
...
for i, trade in enumerate(trades):
    pp.ProgressStatus(i, len(trades), t0)
